  ...
  <v-app>
    <v-navigation-drawer v-model="drawer" fixed app dark>
      ...
      <template v-slot:append>
        ...
        <v-list-item link>
          <v-list-item-content>
            <v-list-item-title style="margin-left: 5px"
              >Atualizar plano</v-list-item-title
            >
          </v-list-item-content>

          <v-list-item-action dark>
            <v-chip color="green" link>
        ...
        await this.$axios
          ...
          .then((res) => {
            if (
              ...
              this.snackbarText =
                "Favor, informe uma palca válida para realizar a pesquisa!";
              ...
              (this.form.vehicleChassi = res.data.response.extra.chassi),
                (this.form.vehicleFuel =
                  res.data.response.extra.combustivel.combustivel),
                ...
                (this.form.vehicleNumberOfPassengers =
                  res.data.response.extra.quantidade_passageiro),
